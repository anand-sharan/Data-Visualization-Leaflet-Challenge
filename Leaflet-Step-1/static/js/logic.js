...
const newLocal = "https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}";
// Define Variables for Tile Layers
var satelliteMap = L.tileLayer(newLocal, {
...
var grayscaleMap = L.tileLayer(newLocal, {
    attribution: "© <a href='https://www.mapbox.com/about/maps/'>Mapbox</a> © <a href='http://www.openstreetmap.org/copyright'>OpenStreetMap</a> <strong><a href='https://www.mapbox.com/map-feedback/' target='_blank'>Improve this map</a></strong>",
    maxZoom: 18,
    id: "mapbox/light-v10",
    accessToken: API_KEY
...
var outdoorsMap = L.tileLayer(newLocal, {
    attribution: "© <a href='https://www.mapbox.com/about/maps/'>Mapbox</a> © <a href='http://www.openstreetmap.org/copyright'>OpenStreetMap</a> <strong><a href='https://www.mapbox.com/map-feedback/' target='_blank'>Improve this map</a></strong>",
    maxZoom: 18,
...
/*mapboxgl.accessToken = 'pk.eyJ1IjoiYW5hbmRzaGFyYW4iLCJhIjoiY2tpaTgwYnI4MDAxbTJybnhzYmZ6MTFhdyJ9.JKuvMt8-5CqkxlBOWtZr7g';
var outdoorsMap = new mapboxgl.Map({
    container: 'map',
